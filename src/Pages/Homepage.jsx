    ...
    <div className={`bg-[url()]`}>
      ...
      >
        ...
        <div className=" z-10  text-white px-2 font-Saira absolute bottom-[2%] text-center w-full">
          ...
          <button className=" lg:hidden border-2 text-black font-semibold text-xl hover:scale-110 transition-all duration-500 border-green-300 bg-green-300 mt-10 rounded-full px-3 py-1 w-max">
